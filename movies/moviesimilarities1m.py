...
conf = SparkConf().setMaster("spark://129.63.16.205:7077").setAppName("Movie Similarity 1 million")
sc = SparkContext(conf = conf)

print "\nLoading movie names..."
nameDict = loadMovieNames()

data = sc.textFile("file:///data/ml-1m/ratings.dat")
...
#moviePairSimilarities.saveAsTextFile("/data/movie-sims")
